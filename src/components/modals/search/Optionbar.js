...
import { onOptionOrderPressed, onOptionCurrentlyOpenPressed } from 'actions/map-reducer-action';
...
const CurrentlyOpenCheckbox = ({ currentlyOpen, onPress }) => (
    <View style={{ flexDirection: 'row' }}>
        <CheckBox
            containerStyle={{ backgroundColor: 'transparent', paddingTop: 10, borderWidth: 0, paddingRight: 0, paddingLeft: 0, marginLeft: 0, marginRight: 0 }}
...
const mapDispatchToProps = dispatch => {
    return bindActionCreators({ onOptionOrderPressed, onOptionCurrentlyOpenPressed }, dispatch);
}
